...
namespace ChannelMonitor.Api.Migrations
{
    ...
    [Migration("20240308144304_AddMessageProviderAndContacts")]
    partial class AddMessageProviderAndContacts
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ChannelMonitor.Api.Entities.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("ChannelMonitor.Api.Entities.ContactsTenant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ChannelMonitor.Api.Entities.MessageProvider", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ChannelMonitor.Api.Entities.Tenant", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("ec576c36-9da4-4d2c-821e-7888f0b4e8a9"),
                            Name = "General"
                        });
                });

            modelBuilder.Entity("ChannelMonitor.Api.Entities.Worker", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ChannelMonitor.Api.Entities.ApplicationUser", b =>
                {
                    b.HasOne("ChannelMonitor.Api.Entities.Tenant", "Tenant")
                        .WithMany()
            ...
            modelBuilder.Entity("ChannelMonitor.Api.Entities.ContactsTenant", b =>
                {
                    b.HasOne("ChannelMonitor.Api.Entities.MessageProvider", "MessageProvider")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ChannelMonitor.Api.Entities.ApplicationUser", null)
                        .WithMany()
